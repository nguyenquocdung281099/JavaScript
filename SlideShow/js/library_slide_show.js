...
var createSlideshow = function () {
  ...
  return {
    ...
    startSlideshow: function () {
      ...
      // clearInterval(timer);
     if(changevalue>100){
      timer = setInterval(displayNextImage, changevalue);
     }
     else if(changevalue<100){
    ...
    changeSpeed: function () {
      ...
      return function () {
        do {
            changevalue = parseInt(prompt("enter new speed in millisseconds (min 100ms) : "));
            that.startSlideshow();
            } while (changevalue <= 100);
      };
        },
